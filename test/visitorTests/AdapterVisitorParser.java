...
import problem.asm.AdapterVisitor;

public class AdapterVisitorParser {
	...
	public void main(ArrayList<String> files, IModel model) throws IOException {
		AdapterVisitorParser.CLASSES = files;
		...
		for (String className : CLASSES) {
			...
			AdapterVisitor av = new AdapterVisitor(Opcodes.ASM5, this.model);
